...
CREATE TABLE `readily_customer` (
  ...
  PRIMARY KEY (`id`),
  KEY `houseReadilyId` (`houseReadilyId`),
  CONSTRAINT `readily_customer_ibfk_1` FOREIGN KEY (`houseReadilyId`) REFERENCES `readily_housereadily` (`id`)
...
CREATE TABLE `readily_housereadily` (
  ...
  `houseNum` varchar(100) DEFAULT NULL,
  `roomNum` int(11) DEFAULT NULL,
  `hallNum` int(11) DEFAULT NULL,
  `toiletNum` int(11) DEFAULT NULL,
  `area` decimal(21,10) DEFAULT NULL,
