...
public class SystemLogDAOImpl extends AbstractSystemLogDAOImpl implements ISystemLogDAO {

	@Override
	public List<SystemLog> findPaging(Integer id, String userName, Integer regSource, String terminal, Integer type, Date beginDate, Date endDate,
			 String sort, String dir, PagingBean pagingBean) {
		StringBuffer hql = new StringBuffer("select o from com.huzhiyi.housereadily.entity.SystemLog o where 1 = 1");
		if (null != id && id > 0) {
